...
UPDATE users SET email = 'petrov@worktime.local' WHERE email = 'olga@worktime.local';
UPDATE users SET email = 'daniil@iqj.app' WHERE email = 'dmitry@worktime.local';
UPDATE users SET email = 'yermolina@iqj.app'    WHERE email = 'tanya@worktime.local';
