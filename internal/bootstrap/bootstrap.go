...
func demoPeople() []demoPerson {
	return []demoPerson{
		{Email: "maxim@worktime.local", FullName: "Максим Малчевский", Role: "employee",
		...
		{Email: "stepan@worktime.local", FullName: "Степан Жаров", Role: "pm",
			Department: "Product", Position: "Проектный менеджер", HRFormat: "remote",
			Timezone: "Europe/Kaliningrad", DaysShift: 45, WorkFormat: "remote",
			HoursStart: "09:00", HoursEnd: "18:00"},
		{Email: "daniil.p@worktime.local", FullName: "Даниил Постников", Role: "hr",
		...
		{Email: "oleg@worktime.local", FullName: "Олег Пламадил", Role: "employee",
		...
		{Email: "alexandr@worktime.local", FullName: "Александр Петров", Role: "analyst",
			Department: "Distributed", Position: "Аналитик данных", HRFormat: "remote",
			Timezone: "Asia/Novosibirsk", DaysShift: 95, WorkFormat: "remote",
			HoursStart: "10:00", HoursEnd: "19:00"},
		{Email: "daniil.i@worktime.local", FullName: "Даниил Игаев", Role: "employee",
		...
		{Email: "sofia@worktime.local", FullName: "Софья Ермолина", Role: "employee",
...
func demoTeams() []demoTeam {
	return []demoTeam{
		{Name: "Platform", OwnerEmail: "igor@worktime.local",
			MemberEmails: []string{"maxim@worktime.local", "igor@worktime.local", "oleg@worktime.local"}},
		{Name: "Product", OwnerEmail: "stepan@worktime.local",
			MemberEmails: []string{"stepan@worktime.local", "sofia@worktime.local", "daniil.p@worktime.local"}},
		{Name: "Distributed", OwnerEmail: "alexandr@worktime.local",
			MemberEmails: []string{"oleg@worktime.local", "alexandr@worktime.local", "daniil.i@worktime.local"}},
	}
}
