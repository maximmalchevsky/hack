<script lang="ts">
	...
	const META: Record<Letter, { title: string; description: string; scale: string }> = {
		...
		C: {
			...
			description:
				'Сколько встреч стоит вне заявленных рабочих часов. Высокое значение — события сдвинуты или график устарел.',
			scale: '0 — всё в графике · 0.2 — есть единичные нарушения · 0.5+ — половина встреч вне графика.'
		},
		L: {
			title: 'Загрузка',
			description:
